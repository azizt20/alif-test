    ...
    >
      <div class="flex lg:flex-1">
        <router-link to="/" class="-m-1.5 p-1.5">
          ...
          <img
            class="h-8 w-auto"
            src="https://upload.wikimedia.org/wikipedia/commons/5/59/Alif_logo.png"
            alt=""
          />
        </router-link>
      </div>
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a
          href="https://github.com/azizt20/alif-test"
          class="text-sm font-semibold leading-6 text-gray-900"
          >Исходники <span aria-hidden="true">&rarr;</span></a
        >
      </div>
    </nav>
    <Dialog
...
const navigation = [
  { name: "Цитаты", href: "/" },
  { name: "Добавить цитату", href: "/add" },
  { name: "Управление", href: "/management" },
];
